...
openxlsx::write.xlsx(clades.organism.NGS, 
                     file.path("..", "output", "01_PSS_tomato-ath_prioritised.xlsx"), 
...
fpo = file.path('..', 'output', 'PSS-DiNAR-input')
dir.create(fpo)
fpo = file.path('..', 'output', 'PSS-DiNAR-input', 'prioritised')
dir.create(fpo)
