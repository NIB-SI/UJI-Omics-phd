...
# orthologr::orthologs = function (query_file, subject_files, seq_type = "protein", outgroup_file = NULL, 
#     eval = "1E-5", format = "fasta", ortho_detection = "RBH", 
#     delete_corrupt_cds = FALSE, cdd.path = NULL, path = NULL, 
#     add_params = NULL, comp_cores = 1, quiet = FALSE, clean_folders = FALSE) 
# {
...
# orthologr::blast_rec = function (query_file, subject_file, seq_type = "cds", format = "fasta", 
...
# orthologr::blast_best = function (query_file, subject_file, seq_type = "cds", format = "fasta",
#     blast_algorithm = "blastp", delete_corrupt_cds = TRUE, eval = "1E-5",
#     max.target.seqs = 10000, path = NULL, comp_cores = 1, blast_params = NULL,
#     clean_folders = FALSE, save.output = NULL)
# {
...
# orthologr::blast = function (query_file, subject_file, seq_type = "cds", format = "fasta", 
#     blast_algorithm = "blastp", eval = "1E-5", max.target.seqs = 10000, 
#     delete_corrupt_cds = TRUE, remote = FALSE, db = NULL, path = NULL, 
...
#     }
#     aa <- geneids <- NULL
#     query.dt <- set_blast(file = query_file, seq_type = seq_type, 
#         format = format, delete_corrupt_cds = delete_corrupt_cds)[[1]]
#     database <- set_blast(file = subject_file, seq_type = seq_type, 
#         format = format, makedb = TRUE, delete_corrupt_cds = delete_corrupt_cds)[[2]]
#     filename <- unlist(strsplit(query_file, .Platform$file.sep, 
#         fixed = FALSE, perl = TRUE, useBytes = FALSE))
...
#                       comp_cores, " -outfmt \"6", " qseqid sseqid pident nident length mismatch gapopen gaps positive ppos qstart qend qlen qcovs qcovhsp sstart send slen evalue bitscore score\""))
#                   }
#                   else {
#                     system(paste0("blastp -db ", database, " -query ", 
#                       input, " -evalue ", eval, " -max_target_seqs ", 
...
#         "n_gaps", "pos_match", "ppos", "q_start", "q_end", "q_len", 
...
filter_best_hits = function (blast_tbl, min_qcovhsp = 50) 
{
    ...
    best_hit_df <- dplyr::do(dplyr::group_by(blast_tbl, species, 
        query_id), filter_best_hits(.))
