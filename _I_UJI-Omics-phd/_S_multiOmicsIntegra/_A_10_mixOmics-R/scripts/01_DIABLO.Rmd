...
cimDiablo(final.diablo.model, size.legend=0.99, margins = c(15, 15),
          xlab = "Variables", ylab = "Samples",
          color.Y = c('pink', 'purple', 'blue', 'yellow'),
          color.blocks = c('orange', 'red', 'green'))
dev.off()
...
#heatmaps
cimDiablo(final.diablo.model, margins = c(13, 13), 
          xlab = "Variables", ylab = "Samples",
          color.Y = c('pink', 'purple', 'blue', 'yellow'),
          color.blocks = c('orange', 'red', 'green'),
          size.legend = 1)
