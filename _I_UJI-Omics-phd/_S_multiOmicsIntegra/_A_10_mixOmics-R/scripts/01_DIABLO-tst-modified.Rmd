...
fn = 'RNA-seq_filtered_24_shortnames.csv'
...
cor(pls4$variates$X, pls3$variates$Y)
cor(pls5$variates$X, pls3$variates$Y)
cor(pls6$variates$X, pls3$variates$Y)
cor(pls7$variates$X, pls3$variates$Y)
cor(pls8$variates$X, pls3$variates$Y)
cor(pls9$variates$X, pls3$variates$Y)
cor(pls10$variates$X, pls3$variates$Y)
```
# Design
